...
Версия 0.8.13
  ...
  Дэниэль Барроу
   ...
   Основной автор данной документации. <dburrows@debian.org>

  Мануэль А. Фернандес Монтесело

   Основной сопровождающий после Дэниэла Барроу, документирование новых
   возможностей, исправления и форматирование. <mafm@debian.org>

   Авторские права © 2004-2011, 2012-2016 Дэниэль Барроу, Мануэль А.
   Фернандес Монтесело
   ...
   2.7. Правило группировки firstchar или firstchar(binary)

   2.8. Правило группировки firstchar(source)
...
Как я могу получить aptitude?
  ...
  Сборка aptitude из исходного кода
   ...
   выполните команду tar zxf aptitude-0.8.13.tar.gz для того, чтобы
   распаковать исходный код. Когда исходный код будет распакован, введите cd
   aptitude-0.8.13 && ./configure && make для того, чтобы скомпилировать
...
Использование aptitude
 ...
 Эти пакеты уже установлены на вашем компьютере.
   ...
   aptitude, нажав Control+t (также работают клавиши Control+Пробел и F10);
   вы также можете кликнуть мышью на нужном пункте меню, если ваша система
   это поддерживает. Нажатие Control+t откроет меню Действий:
...
Использование aptitude из командной строки
   ...
   [Примечание] Примечание
                ...
                dist-upgrade, и это имя все еще распознается aptitude.
...
Терминальный пользовательский интерфейс aptitude
  ...
  Использование меню
   ...
   aptitude. Для активации строки меню, нажмите Control+t (также работают
   клавиши Control+Пробел и F10); вы можете перемещаться по меню, используя
   клавиши со стрелками, и выбирать пункт меню, используя Enter.
  ...
  Меню команд
   ...
   │                            │ «Новые пакеты»).                          │
   ├────────────────────────────┼───────────────────────────────────────────┤
   │                            │ Отметить все запланированные действия     │
   │                            │ данной сессии (включая установки,         │
   │ Действия → Отменить        │ удаления, обновления, фиксации, пометки   │
   │ незаконченные действия     │ пакетов как установленных                 │
   │                            │ автоматически...). Грубо говоря, это      │
   │                            │ соответствует перезапуску программы.      │
   ├────────────────────────────┼───────────────────────────────────────────┤
   ...
   │          Команда          │                  Описание                  │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │ Пакет → Установить (+)    │ Отметить выбранный в данный момент пакет   │
   │                           │ для установки.                             │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │ Пакет → Переустановить    │ Отметить выбранный в данный момент пакет   │
   │ (L)                       │ для переустановки.                         │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │ Пакет → Удалить (-)       │ Отметить выбранный в данный момент пакет   │
   │                           │ для удаления.                              │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │ Пакет → Вычистить (_)     │ Отметить выбранный в данный момент пакет   │
   │                           │ для вычистки.                              │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │                           │ Отменить незаконченные установки,          │
   │ Пакет → Оставить (:)      │ обновления или удаления выбранного в       │
   │                           │ данный момент пакета, а также удалить      │
   │                           │ фиксации, установленные на этом пакете.    │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │ Пакет → Фиксировать (=)   │ Зафиксировать выбранный в данный момент    │
   │                           │ пакет.                                     │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │                           │ Пометить выбранный в данный момент пакет   │
   │                           │ как «установленный автоматически». Более   │
   │ Пакет → Отметить Auto (M) │ подробную информацию о пакетах,            │
   │                           │ установленных вручную или автоматически,   │
   │                           │ см. «Управление пакетами, установленными   │
   │                           │ автоматически».                            │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │                           │ Пометить выбранный в данный момент пакет   │
   │                           │ как «установленный вручную» . Более        │
   │ Пакет → Отметить Manual   │ подробную информацию о пакетах,            │
   │ (m)                       │ установленных вручную или автоматически,   │
   │                           │ см. «Управление пакетами, установленными   │
   │                           │ автоматически».                            │
   ├───────────────────────────┼────────────────────────────────────────────┤
   │                           │ Если выбран пакет, который может быть      │
   │ Пакет → Запретить версию  │ обновлен, запретить его обновление до      │
   │ (F)                       │ доступной в данный момент версии. Если     │
   │                           │ выбрана версия пакета, запретить           │
   │                           │ обновление этого пакета до этой версии.    │
   ├───────────────────────────┼────────────────────────────────────────────┤
   ...
   │ Пакет → Цикл информации о │ отображать длинное описание выбранного в   │
   │ пакете (i)                │ данного момент пакета (поведение           │
   ...
   │ Пакет → История изменений │ выбранного в данный момент пакета. Чтобы   │
   │ (C)                       │ посмотреть список изменений конкретной     │
 ...
 GNU C Library: Динамические библиотеки и данные Timezone
   ...
   новое окно, используя команду Окна → Новое окно Пакета.
...
Управление пакетами
 ...
 piAU  webmin                                        +5837kB <none>     1.160-2
   ...
   T - triggers-pending: включено обновление пакета из-за изменений в другом
       пакете.
 ...
 i A 0.5.25
  ...
  Изменение состояний пакета
   ...
   │ Установить (+)             │ будет обновлён, если это возможно, а      │
   │                            │ любой запрет на обновления, имеющий       │
   │                            │ воздействие на пакет (например,           │
   │                            │ Фиксация), будет отменен.                 │
   ├────────────────────────────┼───────────────────────────────────────────┤
   ...
   │                            │ его текущей версии.                       │
   │                            │                                           │
   │ Оставить: Пакет → Оставить │ Всякое действие, которое должно было быть │
   │ (:)                        │ произведено над пакетом: установка,       │
   ...
   │ Переустановка: Пакет →     │ сохранена по техническим причинам, если   │
   │ Переустановить (L)         │ вы выйдите из aptitude или выполните      │
   │                            │ установочный запуск (в сущности,          │
   │                            │ подлежащие программные слои (dpkg и apt)  │
   │                            │ не позволяют узнать то, была              │
   │                            │ переустановка успешной или же нет).       │
   ├────────────────────────────┼───────────────────────────────────────────┤
   │                            │ Устанавливает, следует ли придавать       │
   │                            │ пакету статус автоматически               │
   │ Пакет → Отметить Auto (M), │ установленного; автоматически             │
   │ Пакет → Отметить Manual    │ установленные пакеты будут удалены, если  │
   │ (m)                        │ они не требуются ни одному другому        │
   │                            │ пакету. Дополнительную информацию см. в   │
   │                            │ разделе «Управление пакетами,             │
 ...
 +------------------------------------------------------------------------------+
   ...
   [Предупреждение] Предупреждение
                    Как только ключ архива добавлен к брелоку APT, этот архив
                    будет рассматриваться как такой же надёжный как основные
                    зеркала Debian! Вам следует делать это только в том
                    случае, когда вы совершенно уверены в том, что ключ,
...
│стоимости│                                              │                                                 │
├─────────┼──────────────────────────────────────────────┼─────────────────────────────────────────────────┤
│         │Решения, включающие лишь «безопасные» действия│                                                 │
│10,000   │(установка для пакета цели по-умолчанию или   │Aptitude::ProblemResolver::Safe-Level,           │
│         │сохранение текущей версии пакета) и удаления  │Aptitude::ProblemResolver::Remove-Level          │
│         │пакетов.                                      │                                                 │
├─────────┼──────────────────────────────────────────────┼─────────────────────────────────────────────────┤
│         │Решение, отменяющее все действия пользователя.│                                                 │
│         │Оно обычно имеет больший вес, чем             │                                                 │
│10,000   │Aptitude::ProblemResolver::Remove-Level, но   │Aptitude::ProblemResolver::Keep-All-Level        │
│         │удаление пакетов всегда имеет больший вес, чем│                                                 │
│         │сохранение тех же пакетов, даже если этот     │                                                 │
│         │пакет должен был быть обновлён.               │                                                 │
├─────────┼──────────────────────────────────────────────┼─────────────────────────────────────────────────┤
│         │Решения, которые ломают фиксации,             │                                                 │
│40,000   │установленные пользователем, или устанавливают│Aptitude::ProblemResolver::Break-Hold-Level      │
│         │запрещённые версии.                           │                                                 │
├─────────┼──────────────────────────────────────────────┼─────────────────────────────────────────────────┤
│         │Решения, которые устанавливают версии не      │                                                 │
│50,000   │по-умолчанию (такие, как например,            │Aptitude::ProblemResolver::Non-Default-Level     │
│         │«экспериментальные»).                         │                                                 │
├─────────┼──────────────────────────────────────────────┼─────────────────────────────────────────────────┤
│60,000   │Действия, которые удаляют пакеты первой       │Aptitude::ProblemResolver::Remove-Essential-Level│
│         │необходимости.                                │                                                 │
└─────────┴──────────────────────────────────────────────┴─────────────────────────────────────────────────┘
   ...
   «maximum» и «minimum». Они обозначают, соответственно, максимально и
   минимальное целочисленное значение, возможное на архитектуре вашей
   системы.
  ...
  Настройка интерактивного решателя зависимостей
   ...
    4. «increase-safety-cost-to число»: увеличить стоимость безопасности
       ...
       [Примечание] Примечание
                    ...
                    дополнение ко всякой стоимости безопасности по-умолчанию,
                    соответствующей выбранному действию. Например, подсказка,
                    увеличивающая стоимость безопасности «установки hal из
                    экспериментального архива» до 15,000, не окажет влияния,
                    так как это действие уже имеет стоимость безопасности
                    равную 50,000 (учитывая, что эта версия пакета hal не
   ...
    8. «:UNINST»: вместо влияния на какую-либо версию цели, подсказка влияет
       на решение удалить цель. Например, «Aptitude::ProblemResolver::Hints {
       "reject aptitude :UNINST"; };» предупредит решатель от попытки удалить
       aptitude.
...
Поисковые шаблоны
   ...
   [Примечание] Примечание
                ...
                aptitude будет расценивать каждое слово (или закавыченную
                строку) как аргумент шаблона ?name, который производит поиск
                пакета, чьё имя соответствует введённому тексту, текст
                интерпретируется как регулярное выражение.

   [Предупреждение] Предупреждение
                    Поведение aptitude в случае, когда данный поисковый
                    шаблон не начинается с «?» (или «~»), предоставляется как
                    удобство для интерактивного использования и будет
                    изменено в будущих выпусках; скрипты, вызывающие aptitude
                    должны явным образом указывать поисковую стратегию,
                    которую следует использовать. То есть, скрипты должны
                    осуществлять поиск по «?name(coq)», а не по «coq»).
  ...
  Сокращения для поисковых терминов
   ...
   [Примечание] Примечание
                ...
                «~napt?priority(required)» будет соответствовать пакетам, чьи
                имена соответствуют регулярному выражению«
                apt?priority(required)». Для того, чтобы объединить краткий
                термин с поисковым термином, определенным по имени, добавьте
                один или несколько пробелов между двумя этими терминами как в
                «~napt ?priority(required)», или поместите текст (если
  ...
  Поиск и версии
   ...
   [Примечание] Примечание
                ...
                пакета, каждый из его терминов проверяется относительно этого
                пакета, и поэтому каждый термин будет соответствовать этому
                пакету, если любая версия пакета ему соответствует. Когда же
                шаблон проверяется относительно каждой версии пакета, он
                будет соответствовать пакету только тогда, когда все его
                термины соответствуют одной и той же версии пакета
                одновременно.

                Например: предположим, что установлена версия 3.0-1 пакета
                aardvark, но доступна версия 4.0-1. Тогда поисковое выражение
                ?version(4\.0-1)?installed соответствует пакету aardvark, так
                как ?version(4\.0-1) соответствует версии 4.0-1 aardvark, в
                то время как ?installed соответствует версии 3.0-1. С другой
                стороны, это выражение не соответствует всем версиям пакета
                aardvark, поскольку нет такой версии, которая бы была
                установлена и имела бы номер версии 4.0-1.
...
│?source-package(имя)                   │~ename                              │с исходными кодами        │
...
└───────────────────────────────────────┴────────────────────────────────────┴──────────────────────────┘
   ...
   [Примечание] Примечание
                Чтобы выбрать пакеты, чьи имена содержат несколько различных
                подстрок, используйте термин ?name (описывается ниже);
                например, «?name(apti)?name(tude)» будет соответствовать
   ...
   [Примечание] Примечание
                Чтобы включить символ «!» в поисковую строку, он должен быть
                «экранирован» путем помещения перед ним тильды («~»); в
                противном случае, aptitude будет рассматривать его как часть
                термина ?not. Например, чтобы выбрать пакеты, чье описание
                содержит «extra!», используйте «?description(extra~!)».
   ...
   [Примечание] Примечание
                Чтобы использовать символ «|» в регулярном выражении, он
                должен быть «экранирован», иначе aptitude создаст из него
                термин ИЛИ: «~|».
   ...
   [Примечание] Примечание
                ...
                действие будет произведено над пакетом, а не то, может ли
                вообще оно быть произведено. Таким образом, например,
                ?action(upgrade) соответствует только тем пакетам, которые вы
                уже решили обновить, а не тем пакетам, которые могут быть
                обновлены в будущем (для последнего, используйте
                ?upgradable).
   ...
   [Примечание] Примечание
                Этот термин тесно связан с ?narrow. Фактически, термин
                ?any-version(шаблон1 шаблон2) делает в точности то же, что
                ?narrow(шаблон1, шаблон2).

   [Примечание] Примечание
                Если быть точным, то как и с любым другим шаблоном выбираются
                не пакеты, а версии пакетов. Для «aptitude search» и других
                подобных команд большой разницы нет, «aptitude versions»
                будет показывать лишь выбранные версии, а не все версии
                пакета, для которого будет в качестве подходящей выбрана
                любая версия. Для этого используйте ?widen.

   ?architecture(спецификация-архитектуры), ~rспецификация-архитектуры

   Выбирает версии пакета для данной спецификации-архитектуры. Например,
   «?architecture(amd64)» выбирает пакеты архитектуры amd64, а
   «?architecture(all)» выбирает все независящие от архитектуры пакеты.

   Также принимаются специальные значения native и foreign, а также шаблоны
   архитектур (напр., linux-any или any-amd64), определённые в Политике
   (раздел «11.1 Architecture specification strings»).
   ...
   описании ?broken-тип-зависимости, а также provides: например,
   ?depends(libpng3) выберет пакеты, которые зависят от libpng3. Если запрос
   используется в короткой форме (~D), и тип-зависимости не указан,
   по-умолчанию выбирается тип depends.
   ...
   дополнение, термин ?=переменная выберет пакеты или версии пакетов, которые
   подходят под значение данной переменной.
   ...
   extra, important, optional, required или standard. Например,
   ...
   Этот термин выбирает любой пакет. Например, «?installed?provides(?true)»
   выбирает установленные пакеты, предоставляющие любой пакет.
   ...
   [Примечание] Примечание
                Заметьте, что проводится проверка только того, доступны ли
                обновления для пакета, а не то можно ли выполнить обновление
                (с такими действиями как safe-upgrade или full-upgrade).

                Например, могут быть доступны обновления для нескольких
                пакетов, но возможно обновлённые версии подмножества этих
                пакетов будут конфликтовать друг с другом, поэтому их нельзя
                установить одновременно, либо не все из них можно за раз
                обновить.
   ...
   ищите \CURRENT.
     ...
     • TARGET выбирает версию пакета, которая выбрана для установки в
       настоящее время, если таковая имеется.
   ...
   «?virtual?reverse-provides(?installed)» выбирает виртуальные пакеты,
   предоставляемые любым установленным пакетом.
...
Настройка aptitude
 ...
 %[ширина][?]код[#]
   ...
   Aptitude::UI::Package-Header-Format и Aptitude::UI::Package-Status-Format
   ...
   aptitude search, используйте опцию -F.

   В форматных строках доступны следующие %-экранирования:

   [Примечание] Примечание
                Некоторые описания, приведенные ниже, указывают на «пакет». В
                графическом интерфейсе это либо отображаемый пакет, либо
                пакет, выбранный в текущий момент; при поиске через командную
                строку, это отображаемый пакет.
   ...
   Экранирование       Имя           Размер    Расширямость      Описание
                                  по-умолчанию
                                                            ...
                                                            это не
                                                            экранирование; оно
   %%            Литерал %        1            Нет          просто вставляет
                                                            знак процента в
                                                            вывод в том месте,
                                                            где вы его
                                                            поставите.
   ...
   %a            Флаг действия    1            Нет          выполняемое над
                                                            ...
                                                            В некотором смысле
                                                            более подробное
   %A            Действие         10           Нет          описание действия,
                                                            которое будет
                                                            выполнено над
                                                            пакетом.
                                                            Если сломанных
   ...
   %c            состояния        1            Нет          пакета, описание в
                                                            Рисунок 2.9,
                                                            «Значения флага
                                                            «текущее
                                                            состояние»».
   ...
   %d            Описание         40           Да           Короткое описание
                                                            пакета.
                                                            Размер пакетного
   %D            Размер пакета    8            Нет          файла, содержащего
                                                            пакет.
                                                            Выводит строку с
   %E            Архитектура      10           Нет          архитектуров,
                                                            например, «amd64».
                                                            Выводит пакет с
                 Пакет с исходным                           исходным кодом,
   %e            кодом            30           Нет          например,
                                                            «aptitude» для
                                                            «aptitude-doc-en».
                                                            Имя компьютера, на
   %H            Имя узла         15           Нет          котором запущен
                                                            aptitude.
                                                            Отображает
                                                            наивысший
                                                            приоритет,
   ...
   %I            установленном    8            Нет          количество места,
                 виде                                       занимаемое пакетом
                                                            на диске.
   %m            Сопровождающий   30           Да           Сопровождающий
                                                            пакета.
                                                            Если пакет
                 Флаг                                       установлен
   %M            автоматической   1            Нет          автоматически,
                 установки                                  выводит «A»; в
                                                            противном случае,
                                                            не выводит ничего.
                                                            Выводит версию
                                                            aptitude,
   %n            Версия программы Длина        Нет          работающую в
                                  «0.8.13».                 настоящий момент,
                                                            в настоящее время
                                                            «0.8.13».
                                                            Выводит имя
   ...
   %O            Источник         30           Нет          например,
                                                            ...
                                                            в контексте
                                                            дерева, имя пакета
   %p            Имя пакета       30           Да           будет выделено
                                                            отступом, если это
                                                            возможно, в
                                                            соответствии с
                                                            глубиной его
   ...
   %r            Число обратных   2            Нет          число
                 зависимостей                               установленных
                                                            ...
                                                            сокращенное
                                                            описание
   %R            Приоритет в      3            Нет          приоритета пакета:
                 сокращенном виде                           например,
                                                            «Important»
                                                            заменяется на
                                                            «Imp».
   ...
   %t            Архив            10           Да           Архив, в котором
                                                            ...
                                                            пакет отмечен
                                                            тегом, в противном
                 Флаг метки                                 случае не выводит
   %T            (также           30           Нет          ничего.^[19]
                 пользовательские
                 метки)                                     Данное поле также
                                                            включает в себя
                                                            пользовательские
                                                            метки.
                                                            Если
   ...
   %V            Версия-кандидат  14           Нет          команда Пакет →
                                                            ...
                                                            дискового
                                                            пространства,
   %Z            Изменение        9            Нет          которое будет
                 размера                                    использовано, либо
                                                            освобождено
                                                            установкой,
                                                            обновлением или
                                                            удалением пакета.
 ...
 firstchar[(режим)]
   ...
   Если быть точным, то это не всегда первая буква — для пакетов,
   начинающихся на lib* именем группы будет liba, libb, ... как в FTP-архиве
   Debian.
   ...
   Группировка по именам двоичных пакетов. Используется по умолчанию, если не
   указан режим.

   Пример 2.7. Правило группировки firstchar или firstchar(binary)

   Если взять пакет с исходным кодом dpkg в качестве примера, то двоичные
   пакеты, dselect, dpkg и dpkg-dev, будут помещены в группу d, а двоичные
   пакеты libdpkg-dev и libdpkg-perl будут добавлены в группу libd.

   source

   Группировка по именам пакетов с исходным кодом.

   Полезно добавлять промежуточные шаги группировки, например, когда
   просматриваются пакеты, созданные из одного и того же пакета с исходным
   кодом (правило группировки source), в больших наборах пакетов (примеры:
   все установленные пакеты, все пакеты с доступными обновлениями, все пакеты
   их раздела «main»). Так можно, например, эмулировать иерархию FTP-архива
   (попробуйте группировку "section(topdir),firstchar(source),source").

   Пример 2.8. Правило группировки firstchar(source)

   Опять же, при выборе пакета с исходным кодом dpkg все двоичные пакеты,
   dselect, dpkg, dpkg-dev, libdpkg-dev и libdpkg-perl, будут сгруппированы в
   d.
 ...
 pattern(шаблон [=> заголовок] [{ правило }] [, ...])
   ...
   Политика, приведенная в примере выше, имеет следующие результаты:
     ...
     • Удаляемые пакеты помещаются в поддерево, обозначенное «Удаляемые
       пакеты»; политика группировки для этого поддерева пуста, поэтому
 ...
 section[(режим[,passthrough])]
   ...
   категории как «non-free/games». Если режим не определен, данный режим
   используется по умолчанию.

   topdir

   Группа основывается на части поля Раздел до первого символа /; если эта
   часть Раздела не распознана, или если её нет /, будет использоваться
   первая запись в списке Aptitude::Sections::Top-Sections.

   subdir

   Группа основывается на части поля Раздел после первого символа /, если она
   содержится в списке Aptitude::Sections::Top-Sections. Если же нет, или
   если отсутствует /, группа основывается на всем поле Раздел.

   subdirs

   Группа основывается на части поля Раздел после первого символа /, если
   часть поля, предшествующая ей содержится в списке
   Aptitude::Sections::Top-Sections; если нет, или если отсутствует /,
   используется все поле. Если имеют место несколько символов / в части
   используемого поля, будет сформирована иерархия групп. Например, если
   «games» не является членом Aptitude::Sections::Top-Sections, то пакеты с
   разделом «games/arcade» будут помещены подзаголовок высшего уровня
 ...
 versions
  ...
  Настройка привязки клавиш
   ...
   │                        │                  │ aptitude предлагает        │
   │ ApplySolution          │ !                │ решение проблемы,          │
   │                        │                  │ немедленно применить это   │
   │                        │                  │ решение.                   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Перейти к началу текущего  │
   │ Begin                  │ home,C-a         │ экрана: в верх списка или  │
   │                        │                  │ в левую часть текстового   │
   │                        │                  │ поля.                      │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Отменяет текущее           │
   ...
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Отображает файл            │
   │ Changelog              │ C                │ changelog.Debian           │
   │                        │                  │ выбранного пакета или      │
   │                        │                  │ версии пакета.             │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Изменяет правило           │
   ...
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Изменяет правило           │
   │ ChangePkgTreeSorting   │ S                │ сортировки текущего        │
   │                        │                  │ активного списка пакетов.  │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Сворачивает выбранное      │
   │ CollapseTree           │ лево             │ дерево в иерархическом     │
   │                        │                  │ списке.                    │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ В диалогах это             │
   │                        │                  │ эквивалентно нажатию «Ok»; │
   │                        │                  │ при взаимодействии со      │
   │ Confirm                │ enter            │ строкой статуса с          │
   │                        │                  │ несколькими вариантами     │
   │                        │                  │ выбора ответа на вопрос,   │
   │                        │                  │ выбирает опцию             │
   │                        │                  │ по-умолчанию.              │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Переключает ввод с         │
   ...
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ DelForward             │ delete,C-d       │ Удаляет символ под         │
   │                        │                  │ курсором при вводе текста. │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   │                        │                  │ Если пакеты сломаны,       │
   │                        │                  │ записывает текущее         │
   │ DumpResolver           │ *                │ состояние решателя проблем │
   │                        │                  │ в файл (для целей          │
   │                        │                  │ отладки).                  │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   │                        │                  │ иерархическом списке.      │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ ExpandTree             │ право            │ Открывает выбранное дерево │
   ...
   │                        │                  │ о том, какие пакеты        │
   │ ForgetNewPackages      │ f                │ являются «новыми»          │
   │                        │                  │ (приводит к очистке списка │
   │                        │                  │ «новых» пакетов).          │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Выбирает последнее         │
   │ LastSolution           │ <                │ решение, созданное         │
   │                        │                  │ решателем проблем.         │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Перемещается влево:        │
   ...
   │                        │                  │ (выбирает предыдущий       │
   │                        │                  │ объект на тем же уровне с  │
   │                        │                  │ тем же родителем).         │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Пытается обновить все      │
   │                        │                  │ пакеты, которые не         │
   │                        │                  │ зафиксированы или не       │
   │ MarkUpgradable         │ U                │ запрещены к обновлению.    │
   │                        │                  │ Также устанавливает новые  │
   │                        │                  │ необходимые и требуемые    │
   │                        │                  │ пакеты.                    │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   │                        │                  │ квадрата в минёре.         │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ MineUncoverSquare      │ Нет привязки     │ Открывает текущий квадрат  │
   │                        │                  │ в минёре                   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Открывает текущий квадрат  │
   │ MineUncoverSweepSquare │ enter            │ в минёре если он закрыт; в │
   │                        │                  │ противном случае очищает   │
   │                        │                  │ вокруг него.               │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ NextPage               │ pagedown,C-f     │ Перемещает текущий экран   │
   │                        │                  │ на одну страницу вперёд.   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Перемещает решатель        │
   │ NextSolution           │ .                │ зависимостей к следующему  │
   │                        │                  │ решению.                   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Эта клавиша выбирает       │
   │ No                     │ n^[b]            │ кнопку «нет» в диалогах с  │
   │                        │                  │ вариантами ответа да/нет.  │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Выбирает родителя          │
   │                        │                  │ выбранного пункта          │
   │ Parent                 │ ^, влево (в меню │ иерархического списка.     │
   │                        │ пакетов)         │ left используется только в │
   │                        │                  │ пакетах (строках) при      │
   │                        │                  │ показе деревьев пакетов.   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ PrevPage               │ pageup,C-b       │ Перемещает текущий экран   │
   ...
   │                        │                  │ для вычистки.              │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Активирует выбранную       │
   │ PushButton             │ space,enter      │ кнопку или переключает     │
   │                        │                  │ флажок.                    │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   ...
   │                        │                  │ отмечает выбранное         │
   │ SolutionActionApprove  │ a                │ действие как "одобренное"  │
   │                        │                  │ (если это возможно, оно    │
   │                        │                  │ будет включено в будущие   │
   │                        │                  │ решения).                  │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ При просмотре решения,     │
   │                        │                  │ отмечает выбранное         │
   │ SolutionActionReject   │ r                │ действие как "отклоненное" │
   │                        │                  │ (будущие решения не будут  │
   │                        │                  │ содержать это действие).   │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Разворачивает или          │
   ...
   │                        │                  │ списке.                    │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ ToggleMenuActive       │ C-m,f10,C-space  │ Активирует или             │
   │                        │                  │ деактивирует главное меню. │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Отменяет последнее         │
   │                        │                  │ действие вплоть до тех     │
   │                        │                  │ пор, когда была запущена   │
   │ Undo                   │ C-_,C-u          │ aptitude ИЛИ до вплоть     │
   │                        │                  │ момента последнего         │
   ...
   │                        │                  │ необходимо, новые списки   │
   │                        │                  │ из сети Интернет.          │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │ Versions               │ v                │ Отображает доступные       │
   │                        │                  │ версии выбранного пакета.  │
   ├────────────────────────┼──────────────────┼────────────────────────────┤
   │                        │                  │ Эта клавиша выбирает       │
   │ Yes                    │ y ^[b]           │ кнопку «Yes» в диалогах с  │
   │                        │                  │ опциями да/нет.            │
   ├────────────────────────┴──────────────────┴────────────────────────────┤
 ...
 Header Static {
   ...
   (например, ScreenStatusColor), который должен использоваться как цвет
   «по-умолчанию» для элемента экрана.
   ...
   она HEADER или STATUS, используется опция
   Aptitude::UI::Package-Header-Format и Aptitude::UI::Package-Status-Format,
   соответственно; в противном случае, используется опция имя .
 ...
 Aptitude {
   ...
   По-умолчанию: false
   Описание: Если значением этой опции является true, то aptitude будет
   чистить устаревшие файлы (см. Действия → Очистить устаревшие файлы) всякий
   раз, когда вы обновляете список пакетов. Эта опция схожа с
   ...
   По-умолчанию: false
   Описание: Если данная опция имеет значение true, то aptitude будет
   выполнять очистку всех файлов в каталоге с кэшем пакетов (см. Действия →
   Очистить кэш пакетов) после успешной установки пакетов (или схожих
   операций). Эта опция похожа на Aptitude::Autoclean-After-Update.
   ...
   По-умолчанию: false
   Описание: Если значением опции является true, то aptitude войдёт в
   визуальный интерфейс для отображения предварительного просмотра
   ...
   По-умолчанию: false
   Описание: Если данная опция включена, то aptitude будет использовать
   пользовательскую локаль для сообщений и дат в файле журнала; в противном
   случае журнал будет вестись в «классической» локали, чтобы журнал не
   писался на других языках (в зависимости от локалей пользователей,
   запустивших программу).
   Опция: Aptitude::Log
   ...
   По-умолчанию: -300
   Описание: Какой вес должен придать решатель проблем невыполнению удаления
   или очистки пакета, для которого было запрошено удаление или очистка.
   ...
   По-умолчанию: 310
   Описание: Какой вес должен придать решатель проблем удалению устаревшего
   пакета (если он ещё не был отмечен для удаления). По меньшей мере,
   значение должно быть равно счётчику RemoveScore, так как он всё равно
   будет применён.
...
Играем в Сапёра
 ...
 Сапёр                                   Сапёр    Проиграл в 2388 секунд
   ...
   [Примечание] Примечание
                Этот раздел в настоящее время довольно неполон, но, вероятно,
                со временем он будет обновляться и расширяться (в частности,
                в связи с огромным количеством источников переводов,
                информация о многих переводчиках отсутствует ^[21]). Если вы
                хотите войти в этот список, пожалуйста вышлите мне на email
                <dburrows@debian.org> письмо с объяснением того, почему вы
                думаете, что должны быть в этом списке.
...
Синтаксис
   ...
   show | showsrc | source | unhold | unmarkauto | versions } пакеты...
...
Действия командной строки
   ...
   Если пакет не был установлен, то он помечается как установленный вручную,
   а свежеустановленные зависимости помечаются как установленные
   автоматически. Если пакет или зависимости уже были установлены, то отметка
   об автоматической установке сохраняется. Дополнительную информацию см. в
   документации в разделе об автоматических установках.

   пакет+M

   Установить пакет и сразу же отметить его как установленный автоматически
   (заметьте, что если ни один пакет не зависит от пакета, это приведёт к его
   ...
   Зафиксировать пакет: отменить любую активную установку, обновление или
   удаление и предотвратить этот пакет от автоматического обновления в
   будущем.

   пакет:

   Оставить пакет в его текущей версии: отменить любую установку, удаление
   или обновление. В отличии от «фиксации» (выше) это действие не
   предотвращает автоматические обновления в будущем.
   ...
   Установить сборочные зависимости для пакета.

   Как специальный случай, «install» без аргументов выполнит любые
   сохранённые/ожидающие действия.

   [Примечание] Примечание
                Когда вы вводите Y в окончательном запросе подтверждения,
                команда «install» изменит сохранённую aptitude информацию о
                том, какие действия следует выполнить. Поэтому, если вы
                используете (например) команду «aptitude install foo bar» на
                ранее неустановленных пакетах, и затем установка завершается
                неудачно, когда программа aptitude уже начала загрузку и
                установку пакетов, то вам необходимо будет запустить
                «aptitude remove foo bar» для возврата к предыдущее состояние
                (а также возможно придётся отменить установку и обновления
                других пакетов, которые были вызваны действием «install»).

   remove, purge, reinstall

   Эти команды совпадают с командой «install», но применяют выбранное
   действие ко всем пакетам, указанным в командной строке, для которых оно не
   отменено.
   ...
   только архитектурно-зависимая сборка пакетов (то есть, не
   Build-Depends-Indep или Build-Conflicts-Indep ).
   ...
   Отметить пакеты как удержанные, удалить это свойство или сохранить текущее
   состояние. Пакеты указываются в точности тем же способом как и для команды
   «install». Например, «aptitude hold '~e^dpkg$'» пометит все пакеты,
   собранные из пакета с исходным кодом «dpkg» как удержанные.

   Различие между hold и keep состоит в том, что hold приведёт к
   игнорированию пакета при выполнении в будущем команд safe-upgrade или
   full-upgrade, а keep просто отменит любые запланированные действия для
   данного пакета. Команда unhold позволяет в будущем обновлять пакет при
   помощи safe-upgrade или full-upgrade, не изменяя его состояние.
   ...
   Данная команда принимает в качестве аргументов имена пакетов или шаблоны.
   Если строка содержит символ тильды («~») или знак вопроса («?»), то она
   считается поисковым шаблоном, и будет рассмотрен всякий пакет, подпадающий
   под этот шаблон (см. раздел «Поисковые шаблоны» в справочном руководстве
   aptitude).

   forbid-version

   Запретить обновление пакета до определённой версии, разрешив в то же время
   автоматическое обновление до более поздних версий. Это полезно, например,
   для того, чтобы избежать установки заведомо сломанной версии пакета без
   ручного выставления и последующей очистки фиксации для этого пакета.

   По умолчанию aptitude выберет запрещённую версию как ту версию, до которой
   при обычных условиях будет обновлён пакет (версия-кандидат). Это поведение
   можно отменить, добавив «=версия» к имени пакета. Например, «aptitude
   forbid-version vim=1.2.3.broken-4».

   Для отмены действия выполните «aptitude install пакет», что приведёт к
   удалению запрета. Для удаления запрещённой версии без установки
   версии-кандидата следует добавить текущую версию: «install пакет=версия».
   ...
   устанавливая пакеты, если это необходимо. Также выполняется установка
   новых необходимых и требующихся пакетов. Эта команда менее консервативна,
   чем safe-upgrade, и потому более вероятно, что она произведёт
   ...
   [Примечание] Примечание
                Эта команда изначально названа dist-upgrade по историческим
                причинам, и aptitude все ещё распознает dist-upgrade как
   ...
   [Примечание] Примечание
                В примере выше, «aptitude search '~N' edit» имеет два
                аргумента после search и, поэтому, производится поиск по двум
                шаблонам: «~N» и «edit». Как это описано в руководстве по
                поисковым шаблонам, один шаблон, составленный из двух
                подшаблонов, разделённых пробелом (такой как «~N edit»),
                соответствует какому-то пакету только в том случае, если оба
                эти шаблона соответствуют пакету. Таким образом, команда
                «aptitude search '~N edit'» покажет только «новые» пакеты,
                чьи имена содержат «edit».
 ...
 ihA raptor-utils                    - утилиты для анализа и преобразования RDF
   ...
   Отображает подробную информацию об одном или нескольким пакетам с исходным
   кодом.
   ...
   Загружает один или несколько пакетов с исходным кодом.
 ...
 i A texlive-latex-extra Конфликтует textopo
   ...
   Если имеет место один или несколько шаблонов (в дополнение к обязательному
   последнему аргументу, которым должно быть правильное имя пакета), то
   aptitude начнёт поиск с этих шаблонов. То есть, первым выведенным пакетом
   в цепочке, объясняющей то, почему установлен или не установлен пакет,
   будет пакет, подходящий под данный шаблон. Эти шаблоны считаются именами
   пакетов, если они не содержат знак тильды («~») или знак вопроса («?»),
   если же они содержат эти символы, то они считаются поисковыми шаблонами
   (см. раздел «Поисковые шаблоны» справочного руководства aptitude).
   ...
   [Примечание] Примечание
                aptitude why не выполняет полное разрешение зависимостей; эта
                команда лишь отображает прямые взаимосвязи между пакетами.
                Например, если A требует B, C требует D, а B и C конфликтуют,
                «aptitude why-not D» не выдаст ответ «A зависит от B, B
   ...
   Загружает файл .deb для данного пакета в текущий каталог.
...
Опции
   ...
   "new-installs,?action(install)" добавит тег new-installs ко всем пакетам,
   устанавливаемым при помощи команды safe-upgrade.
 ...
 libdbix-fulltextsearch-perl 0.73-10
   ...
   каких-либо пакетов. По-умолчанию кэш пакетов хранится в
   ...
   Aptitude::CmdLine::Package-Display-Format; для versions, это соответствует
   опции настройки Aptitude::CmdLine::Version-Display-Format.
   ...
   «безопасного» решателя, активируемого командой --safe-resolver, полный
   решатель может удалять пакеты для удовлетворения зависимостей. Он может
   разрешить больше ситуаций, чем безопасный алгоритм, но его решения менее
   желательны.

   Опция может использоваться для того, чтобы всегда использовался полный
   решатель, даже если включена опция Aptitude::Always-Use-Safe-Resolver.
   ...
   порядке) являются off, fatal, error, warn, info, debug, и trace.
   По-умолчанию уровень записи в журнал имеет значение warn.
   ...
   оказывает наиболее конкретная установка, поэтому если вы передадите
   --log-level=aptitude.resolver:fatal и
   --log-level=aptitude.resolver.hints.match:trace, то сообщения в
   aptitude.resolver.hints.parse будут выведены только в том случае, если их
   уровень равен fatal, но все сообщения в aptitude.resolver.hints.match
   также будут выведены. Если вы установите уровень одной и той же категории
   два или несколько раз, эффект окажет последняя установка.
   ...
   настройку, включает внутренние события программы, ошибки и отладочные
   сообщения. См. опцию командной строки --log-file, чтобы изменить то, куда
   отправляются сообщения журнала.
   ...
   инструментами. Эквивалентно опции командной строки
   ...
   используется безопасный решатель (то есть, была передана опция
   ...
   пакеты. Эта опция оказывает действие независимо от значения
   Aptitude::Safe-Resolver::No-New-Installs.
   ...
   Добавление к началу ключевого слова символа тильды (~) обращает порядок от
   восходящего к нисходящему.

   Порядок сортировки по-умолчанию: имя,версия.

   -o ключ=значение

   Устанавливает опцию файла настроек напрямую; например, используйте -o
   Aptitude::Log=/tmp/my-log, чтобы записать журнал действий aptitude в
   ...
   (по-умолчанию), то в дополнение к удалению каждого пакета, который более
   не требуется ни одному установленному пакету, aptitude также вычистит их,
   ...
   Соответствует паре опций настройки APT::Install-Recommends и
   ...
   "not-upgraded,?action(upgrade)" удалит тег not-upgraded у всех пакетов,
   которые могут быть обновлены выполнением команды safe-upgrade .
   ...
   установит версию пакета, которая не является версией-кандидатом
   по-умолчанию. Этот же алгоритм используется в safe-upgrade; в самом деле,
   ...
   следующие настройки:
     ...
     • auto: отображать имена пакетов, когда выполняется aptitude versions,
       ...
       шаблон аргумента, или если имеется более одного аргумента.
   ...
    2. first-package: отобразить первый пакет в каждой цепочке. Если РЕЖИМ не
       указан, по-умолчанию берется это значение.

    3. first-package-and-type: отобразить первый пакет в каждой цепочке, а
       также силу самой слабой зависимости в цепочке.

    4. all-packages: кратко отобразить каждую цепочку зависимостей, ведущих к
       целевому пакету.

    5. all-packages-with-dep-versions: кратко отобразить каждую цепочку
       зависимостей, ведущую к целевому пакету, включая целевую версию каждой
       зависимости.
 ...
 Пакеты, требующие libglib2.0-data:
   ...
   Выбрать выпуск, из которого следует установить пакеты. Например, «aptitude
   -t experimental ...» установкит пакеты из экспериментального выпуска в том
   случае, если вы не укажите обратное.
 ...
 Следующие НОВЫЕ пакеты будут установлены:
   ...
   Aptitude::CmdLine::Verbose, отображает всю цепочку зависимостей, которая
 ...
 Следующие пакеты будут УДАЛЕНЫ:
   ...
   search и versions (в командной строке).

   По умолчанию, а также когда вывод виден напрямую в терминале, используется
   ширина терминала. Если же вывод перенаправляется или передаётся через
   канал другой программе, то используется очень большая «неограниченная»
   ширина строки, а данная опция игнорируется.
...
Описание
   ...
   [Примечание] Примечание
                Данная команда в основном предназначена для внутреннего
                использования и сообщения об ошибках в исключительных
                случаях, она не предназначена для конечных пользователей в
                обычных условиях.
...
Опции
   ...
   строки при вызове программы, отменяя любые предыдущие --append-args
   (по-умолчанию опции должны быть помещены в начале).
